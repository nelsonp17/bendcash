<template>
	...
	>
		<h1 class="text-2xl font-semibold whitespace-nowrap">Panel de control</h1>
		<div v-if="false" class="space-y-6 md:space-x-2 md:space-y-0">
			<a
	...
	<div class="grid grid-cols-1 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-4">
		<template v-for="i in 4" :key="i">
			<card-content-widget-dashboard-one/>
		</template>
	</div>

	<table-info-user-dashboard/>
	...
	<!-- Start Content -->
	<div v-if="false" class="grid grid-cols-1 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-4">
		<template v-for="i in 4" :key="i">
	...
	<h3 v-if="false" class="mt-6 text-xl">Users</h3>
	<div v-if="false" class="flex flex-col mt-6">
...
import CardContentWidgetDashboardOne from "../../../widgets/cardContentWidgetDashboardOne.vue";
import TableInfoUserDashboard from "../../../widgets/tableInfoUserDashboard.vue";

export default defineComponent({
	name: "contentRootDashboard",
	components: {TableInfoUserDashboard, CardContentWidgetDashboardOne}
})
</script>
